let assert,compileAndExecute,printResult;_8af‍.w("assert",[["default",["assert"],function(v){assert=v}]]);_8af‍.w("../src/main",[["compileAndExecute",["compileAndExecute"],function(v){compileAndExecute=v}],["printResult",["printResult"],function(v){printResult=v}]]);
