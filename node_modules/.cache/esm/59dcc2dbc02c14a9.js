let child,assert,parseArgumentsToOptions,promptForMissingOptions;_c02‍.w("child_process",[["default",["child"],function(v){child=v}]]);_c02‍.w("assert",[["default",["assert"],function(v){assert=v}]]);_c02‍.w("../src/cli",[["parseArgumentsToOptions",["parseArgumentsToOptions"],function(v){parseArgumentsToOptions=v}],["promptForMissingOptions",["promptForMissingOptions"],function(v){promptForMissingOptions=v}]]);let stdin = require('mock-stdin').stdin();
