let path,chalk;_23c‍.x([["compileAndExecute",()=>compileAndExecute],["printResult",()=>printResult],["processScriptOptions",()=>processScriptOptions]]);_23c‍.w("path",[["default",["path"],function(v){path=v}]]);_23c‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);let ivm = require('isolated-vm');
let fs = require('fs');
  ...
  // Console hook start.
  _23c‍.g.console.stdlog = _23c‍.g.console.log.bind(_23c‍.g.console);
  _23c‍.g.console.logs = [];
  _23c‍.g.console.log = function(){
    _23c‍.g.console.logs.push(Array.from(arguments));
    _23c‍.g.console.stdlog.apply(_23c‍.g.console, arguments);
  }
  // Console hook end.

  // Start of the actual printing:
  _23c‍.g.console.log("Filename: %s\nLogs: %s\nResult: %s\n", result.filename, result.logs.toString(), result.result);
  ...
  if(printIsolateStats && result.cpuTime && result.wallTime ) {
    ...
    _23c‍.g.console.log("Heap Stats: %s\nCpu time: %s\nWall time: %s", result.heapStats, cpuInMil, wallInMil);
  }

  return _23c‍.g.console.logs;
}
