_e5e‍.x([["processScriptOptions",()=>processScriptOptions]]);let ivm = require('isolated-vm');
let fs = require('fs');
...
function printResult(result) {
  ...
  if(options.runAllInDir) {
    // call function that gets all .js files and then passes them each to compileAndExecute
  }
  else {
