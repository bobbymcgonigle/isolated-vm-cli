let ivm,assert,fs,path,chalk;_878‍.x([["compileAndExecute",()=>compileAndExecute],["printResult",()=>printResult],["processScriptOptions",()=>processScriptOptions]]);_878‍.w("isolated-vm",[["default",["ivm"],function(v){ivm=v}]]);_878‍.w("assert",[["default",["assert"],function(v){assert=v}]]);_878‍.w("fs",[["default",["fs"],function(v){fs=v}]]);_878‍.w("path",[["default",["path"],function(v){path=v}]]);_878‍.w("chalk",[["default",["chalk"],function(v){chalk=v}]]);
  ...
  // Console hook start.
  if(debugMode) {
    _878‍.g.console.stdlog = _878‍.g.console.log.bind(_878‍.g.console);
    _878‍.g.console.logs = [];
    _878‍.g.console.log = function(){
      _878‍.g.console.logs.push(Array.from(arguments));
    }
  }
  // Console hook end.

  _878‍.g.console.log("Filename: %s\nLogs: %s\nResult: %s\n", result.filename, result.logs.toString(), result.result);
  ...
  if(printIsolateStats && result.cpuTime && result.wallTime ) {
    ...
    _878‍.g.console.log("Heap Stats: %s\nCpu time: %s\nWall time: %s", result.heapStats, cpuInMil, wallInMil);
  }
  return _878‍.g.console.logs;
}
