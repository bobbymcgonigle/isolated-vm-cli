let assert,compileAndExecute,printResult;_b53‍.w("assert",[["default",["assert"],function(v){assert=v}]]);_b53‍.w("../src/main",[["compileAndExecute",["compileAndExecute"],function(v){compileAndExecute=v}],["printResult",["printResult"],function(v){printResult=v}]]);
